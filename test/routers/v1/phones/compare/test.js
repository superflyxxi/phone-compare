...
describe('Phone-compare positive tests', () => {
	before(() => {
		// create the phones
		// pixel 5
		chai.request(app).put('/v1/phones/manufacturers/google/models/GD1YQ').send({
			name: 'Google Pixel 5',
		...
		// pixel 4
		chai.request(app).put('/v1/phones/manufacturers/google/models/G020I').send({
			name: 'Google Pixel 4',
		...
		// nexus 4
		chai.request(app).put('/v1/phones/manufacturers/LG/models/E960').send({
			name: 'LG Nexus 4',
